(function () {
    ...
    function renderProductCardsView(container, data) {
        const cardsData = {
            ...
            'pqc-main': [
                { title: 'PQC Hardware Solutions',             desc: 'Provides a comprehensive suite of post-quantum cryptography hardware, including CryptoBoxes, IP cores, and Root-of-Trust modules.', href: 'https://fortifyiq.com/pqc/fortipqc-hw/' },
                { title: 'PQC Software Libraries',             desc: 'Provide high-assurance cryptographic protection, engineered for AVA_VAN.5 compliance and designed for high-security certification.', href: 'https://fortifyiq.com/pqc/fortipqc-software-libraries-pqc/' },
                { title: 'PQC Hybrid + Classical',             desc: 'CryptoBoxes and Roots of Trust (RoTs) integrate post-quantum and classical cryptography in a unified, high-assurance architecture.', href: 'https://fortifyiq.com/pqc/hybrid-pqc/' },
                { title: 'FAQ: Our Post Quantum Cryptography', desc: 'Why post-quantum cryptography matters? Etc.',                                                                                          href: 'https://fortifyiq.com/pqc/faq-our-post-quantum-cryptography-pqc/' },
                { title: 'PQC: Myths vs Facts',                desc: 'The most popular myths and facts about post-quantum cryptography.',                                                                    href: 'https://fortifyiq.com/pqc/pqc-myths-vs-facts/' },
            ],
            forti: [
                { title: 'Fault Injection Studio',             desc: 'Enables engineers to evaluate and strengthen hardware designs against fault injection attacks, e.g., DFA, SIFA, and AFA.',                                                              href: 'https://fortifyiq.com/forti-eda-validation-studios/fault-injection-studio/' },
            ...
            pqc: [
                {
                    ...
                    items: [
                        ...
                        { label: 'ML-KEM Hardened Post-Quantum Signature Cryptographic Library',         url: 'https://fortifyiq.com/products/fiq-pqc-01-cl-ml-kem-cryptographic-library/' },
                        { label: 'ML-DSA Hardened Post-Quantum Key Encapsulation Cryptographic Library', url: 'https://fortifyiq.com/products/fiq-pqc-02-cl-ml-dsa-cryptographic-library/' },
                    ],
                },
            ],
            aes: [
